...
class MockConfigEntry:
    """Minimal fallback for tests.common.MockConfigEntry used by static analysis."""

    def __init__(self, domain, unique_id=None, data=None, entry_id="mock_entry"):
        self.domain = domain
    ...
    def add_to_hass(self, hass):
        """No-op fallback; real test runtime should provide the proper MockConfigEntry."""
        return None
...
def mock_victron_hub():
    ...
    with patch(
        f"{PATCH_CONFIG_FLOW_NAME}.VictronVenusHub"
    ) as mock_hub:

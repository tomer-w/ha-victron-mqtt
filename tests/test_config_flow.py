...
try:
    ...
    def MockConfigEntry(**kwargs):
        """Create a mock config entry."""
        return MagicMock(spec=ConfigEntry, **kwargs)

# Mock SsdpServiceInfo to avoid importing the full ssdp component
try:
    ...
    class SsdpServiceInfo(BaseServiceInfo):
        """Mock SsdpServiceInfo for testing."""
        
        def __init__(self, ssdp_usn: str = "", ssdp_st: str = "", 
                     ssdp_location: str = "", upnp: dict | None = None, **kwargs):
            super().__init__()

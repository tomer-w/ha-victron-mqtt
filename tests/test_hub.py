...
from custom_components.victron_mqtt.hub import Hub, VictronSensor
...
PATCH_HUB_NAME = "custom_components.victron_mqtt.hub"
...
def mock_victron_hub():
    ...
    with patch(
        f"{PATCH_HUB_NAME}.VictronVenusHub"
    ) as mock_hub_class:
...
async def test_create_entity_sensor(
    ...
    with patch(
        f"{PATCH_HUB_NAME}.VictronSensor"
    ) as mock_sensor:
...
async def test_create_entity_binary_sensor(
    ...
    with patch(
        f"{PATCH_HUB_NAME}.VictronBinarySensor"
